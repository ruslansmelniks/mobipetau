...
const conversations = [
    ...
    messages: [
      {
        id: "1",
        sender: "owner",
        text: "Hello! I'm concerned about Twinnie. She hasn't been eating much for the past two days and seems lethargic. I'm worried about her.",
        timestamp: "2025-06-08T14:30:00Z",
      },
      {
        id: "2",
        sender: "vet",
        text: "Hi John! I understand your concern. Has Twinnie had any other symptoms like unusual droppings or difficulty breathing?",
  ...
  },
  {
    ...
    lastMessageTime: "2025-06-04T10:35:00Z",
    messages: [
      {
        id: "1",
        sender: "vet",
        text: "Hello Sarah! I'm Dr. Johnson and I'll be seeing Max for his regular checkup. Is there anything specific you'd like me to look at?",
        timestamp: "2025-06-04T10:15:00Z",
      },
      {
        id: "2",
        sender: "owner",
        text: "Hi Dr. Johnson! Max has been scratching his ears a lot lately. Could you take a look at them during the checkup?",
      ...
      },
      {
        id: "5",
        sender: "vet",
        text: "It's possible. Water trapped in the ears can lead to infections. I'll check for that specifically. See you tomorrow at 3 PM!",
  ...
  },
  {
    ...
    service: "Vaccination",
    lastMessageTime: "2025-05-21T15:20:00Z",
    messages: [
      {
        id: "1",
        sender: "vet",
        text: "Hello Michael! I'll be administering Whiskers' vaccinations tomorrow. Just wanted to check if you have any questions before our appointment?",
        timestamp: "2025-05-21T15:10:00Z",
      },
      {
        id: "2",
        sender: "owner",
        text: "Hi Dr. Johnson! Will there be any side effects I should watch for after the vaccination?",
        timestamp: "2025-05-21T15:15:00Z",
      },
      {
        id: "3",
        sender: "vet",
        text: "Great question! Some cats may be a bit lethargic for 24-48 hours after vaccination. A small, firm lump at the injection site is also normal and should disappear within a few weeks. If you notice any vomiting, diarrhea, or difficulty breathing, please contact me immediately as these could indicate an allergic reaction.",
...
export default function VetMessagesPage() {
  ...
  const handleSendMessage = (e: React.FormEvent) => {
    ...
    setTimeout(() => {
      const ownerResponse = {
        id: `new-${Date.now() + 1}`,
        sender: "owner",
        text: "Thank you for the information. I'll make sure to follow your advice.",
        timestamp: new Date().toISOString(),
      }
      setMessages((prev) => [...prev, ownerResponse as any])
    }, 1000)
  }
  ...
  const filteredConversations = conversations.filter((conv) =>
    conv.owner.name.toLowerCase().includes(searchTerm.toLowerCase()),
  )
                    ...
                    <div className="flex items-start gap-3">
                      <div className="relative flex-shrink-0">
                        <div className="w-12 h-12 rounded-full overflow-hidden">
                          <Image
                            src={conversation.owner.image || "/placeholder.svg"}
                        ...
                        <span
                          className={cn(
                            ...
                            getStatusColor(conversation.owner.status),
                          )}
                        ></span>
                      </div>
                      <div className="flex-1 min-w-0">
                        <div className="flex justify-between items-baseline">
                          <h3 className="font-medium truncate">{conversation.owner.name}</h3>
            ...
            <div className="flex items-center">
              <div className="flex items-center">
                <div className="w-10 h-10 rounded-full overflow-hidden mr-3">
                  <Image
                    src={activeConversation.owner.image || "/placeholder.svg"}
                ...
                <div>
                  <div className="flex items-center gap-2">
                    <h2 className="font-medium">{activeConversation.owner.name}</h2>
                    <span
                      className={cn("w-2 h-2 rounded-full", getStatusColor(activeConversation.owner.status))}
                    ></span>
                  </div>
          ...
          <ScrollArea className="flex-1 p-4">
            <div className="space-y-4">
              ...
              {messages.map((message, index) => {
                const isVet = message.sender === "vet"
                const showDate =
                  index === 0 ||
                ...
                return (
                  <div key={message.id}>
                    ...
                    <div className={cn("flex", isVet ? "justify-end" : "justify-start")}>
                      <div className="flex items-end gap-2 max-w-[80%]">
                        ...
                        >
                          ...
                          <span className={cn("text-xs mt-1 block", isVet ? "text-teal-50" : "text-gray-500")}>
