-- Fix the fetchnotificationswithdetails function to use appointment_id instead of reference_id
-- Migration: 20250103000002_fix_notifications_rpc.sql

-- Drop the existing function
DROP FUNCTION IF EXISTS fetchnotificationswithdetails(UUID);
